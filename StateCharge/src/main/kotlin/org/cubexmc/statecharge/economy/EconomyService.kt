package org.cubexmc.statecharge.economy
...
/**
 * Vault 经济封装(照抄 Contract 的 EconomyService:setup 失败时由主类 abortEnable)。
 */
class EconomyService(private val plugin: StateChargePlugin) {
