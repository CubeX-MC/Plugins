...
public class TrainMovementTask implements Listener {
    ...
    public void cancel() {
        ...
        session.getPlugin().getBedrockCompatibility().onTrainDeparture(minecart);
    ...
    private void transitionToStoppedAtStation(Stop stop) {
        ...
        movementAssistController.stop();
        session.getPlugin().getBedrockCompatibility()
                .onTrainArrival(session.getPassenger(), minecart);
    ...
    private void handleDeparture() {
        ...
        session.getPlugin().getBedrockCompatibility().onTrainDeparture(session.getMinecart());
